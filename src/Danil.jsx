        ...
        <div>
            ...
            <div className="danil">
                ...
                <div className="elena__info">
                    ...
                    <p className="about__para">Danil’s interest in choral music started in his
                    ...
                    <p className="about__para">With a Bachelor’s degree from Minsk Conservatory of Music,
                    ...
                    <p className="about__para">In addition to many teaching and conducting experiences
