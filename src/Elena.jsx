        ...
        <div>
            ...
            <div className="danil">
                ...
                <div className="elena__info">
                    ...
                    <p className="about__para">Elena is a passionate and dedicated musician, whose
                    ...
                    <p className="about__para">Elena’s fascination and passion for choir began in her childhood and
                    ...
                    <p className="about__para">After coming to Canada in 1997, Elena resumed her music career when she opened
